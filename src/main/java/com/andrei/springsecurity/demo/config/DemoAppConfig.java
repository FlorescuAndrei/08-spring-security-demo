...
@ComponentScan(basePackages="com.andrei.springsecurity.demo")
...
public class DemoAppConfig {
	...
	public DataSource securityDataSource() {
		...
		//log the connection props for personal info check
